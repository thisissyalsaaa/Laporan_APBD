...
<body>
    ...
    <section>
        ...
        <a href="add_view.php" class="btn btn-primary">Tambah Data</a>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <?php } ?>
                <script>
                document.getElementById('print-other').addEventListener('click', function() {
                    var printWindow = window.open('cetak.php', '_blank');
